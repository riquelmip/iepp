                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="list-group text-dark">
                        <?php foreach ($data['versiculos'] as $key => $versiculo) {  ?>
                                <a href="<?= base_url()?>/Bibliaweb/Versiculo/<?= $data['idlibro']; ?>/<?= $data['capitulo']; ?>/<?= $key; ?>" class="list-group-item list-group-item-action"><?php echo $versiculo?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modalVer" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body" id="modalVerbody">  
            ...
            ?>
                <a href="<?= base_url()?>/Bibliaweb/Libro/<?= $data['idlibro']; ?>/<?= $i;?>" class="list-group-item list-group-item-action"><?php echo "Capitulo ".$i?></a>
            <?php } ?>
            </div>
        </div>

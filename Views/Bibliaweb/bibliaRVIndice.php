...
?> 
<?php 
$url = base_url().'/Biblias/indiceBiblia.json';
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35 text-center">
                            <h2>Bíblia Reina Valera 1960</h2>
							              <span>Indice</span>
										  <button href="#" class="genric-btn primary circle">Antiguo Testamento</button>
										  <button href="#" class="genric-btn primary circle">Nuevo Testamento</button>
                        </div>
						...
						<table class="table table-bordered">
							<tbody>
								...
								?>
									<tr>
										<td><a class="btn-block genric-btn default" href="<?= base_url()?>/Bibliaweb/Libro/<?= $indicefinal['biblia'][$i]['numero']; ?>/1"><?= $indicefinal['biblia'][$i]['titulo']; ?></a></td>
										<?php
											$i=$i+40;

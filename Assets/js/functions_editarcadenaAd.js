...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableDetallesCadenasAd = $('#tableDetallesCadenaAd').dataTable( {
        "aProcessing":true,
        "aServerSide":true,
        "language": {
        ...
        "ajax":{
            "url": " "+base_url+"/Cadenas/getCorosAd",
            "dataSrc":""
        },
        "columns":[
            {"data":"idcoro"},
    ...
    //NUEVO 
    if (document.querySelector("#formCadenaAd")) {
        
    

    let formCadenaAd = document.querySelector("#formCadenaAd");
        formCadenaAd.onsubmit = function(e) {
            e.preventDefault();
            ...
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Cadenas/editCadenaAd/1';  //el primer 1 es de estado =1 es decir, activo
            let formData = new FormData(formCadenaAd);
                ...
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status)
                    {
                        ...
                        swal({
                          ...
                          function(){
                               window.location.href = base_url+"/Cadenas/CadenasAd";
                          });
...
$("#formCadenaAd").on("click", "button.quitarCoro", function(){

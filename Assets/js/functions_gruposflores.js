...
let tableGruposFlores;
let rowTable = "";
let divLoading = document.querySelector('#divLoading');
document.addEventListener('DOMContentLoaded', function(){

    tableGruposFlores = $('#tableGruposFlores').dataTable( {
        "aProcessing":true,
        "aServerSide":true,
        "language": {
        ...
        "ajax":{
            "url": " "+base_url+"/Privilegios/getGruposFlores",
            "dataSrc":""
        },
        "columns":[
            {"data":"id"},
    ...
    let formGrupos = document.querySelector("#formGrupos");
        formGrupos.onsubmit = function(e) {
           ...
           tinyMCE.triggerSave();//guardar lo que hay en el editor guardarlo en el txtPredica
            ...
            let ajaxUrl = base_url+'/Privilegios/setGrupoFlores'; 
                ...
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status)
                    {
                        ...
                        if (rowTable == "") {
                            ...
                            tableGruposFlores.api().ajax.reload();
                        }else{
...
function openModal()
{
    ...
    document.querySelector('#titleModal').innerHTML = "Nuevo Grupo de Flores";
